...
class Constants {
    ...
    ARGOPM_LIBRARY_VERSION_LABEL = "workflows.argoproj.io/version"
    ARGOPM_LIBRARY_PARENT_LABEL = "workflows.argoproj.io/parent"
    ARGOPM_LIBRARY_REGISTRY_LABEL = "workflows.argoproj.io/registry"
    ARGOPM_LIBRARY_DESCRIPTION_LABEL = "workflows.argoproj.io/description"
    ARGOPM_LIBRARY_HOMEPAGE_LABEL = "workflows.argoproj.io/homepage"
    ARGOPM_LIBRARY_AUTHOR_LABEL = "workflows.argoproj.io/author"
    ARGOPM_LIBRARY_REPO_LABEL = "workflows.argoproj.io/repository"
    ARGOPM_LIBRARY_SUPPORT_LABEL = "workflows.argoproj.io/support"
    ARGOPM_LIBRARY_KEYWORD_LABEL = "workflows.argoproj.io/keywords"

    ARGOPM_INSTALLER_LABEL = "workflows.argoproj.io/installer"
