...
class Package {
    ...
    delete(cluster) {
        ...
        return this.dependencies(cluster).then(dependencyPackages => {
            ...
            return capturedThis.cronWorkflows();
        }).then(_ => {
    ...
    deleteConfigMaps() {
        return this.configMaps().then(configMaps => {
            return Promise.each(configMaps, function (configMap) {
                ...
                return coreK8sApi.deleteNamespacedConfigMap(metadata.name, metadata.namespace, null, null, null, null, null, null)
            })
        })
    }
     ...
     deleteSecrets() {
        return this.secrets().then(secrets => {
            return Promise.each(secrets, function (secret) {
                ...
                return coreK8sApi.deleteNamespacedSecret(metadata.name, metadata.namespace, null, null, null, null, null, null)
            })
        })
    }
        ...
        return this.pipelines().then(pipelines => {
            return Promise.each(pipelines, function (pipeline) {
                ...
                return customK8sApi.deleteNamespacedCustomObject(constants.ARGO_DATAFLOW_K8S_API_GROUP, constants.ARGO_K8S_API_VERSION, 
                    this.metadata.namespace, plural, metadata.name, null, null, null, null, null, null)
            })
        })
    }
