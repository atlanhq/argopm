...
class Package {
    ...
    configMaps(namespace) {
        return coreK8sApi.listNamespacedConfigMap(namespace, null, null, null, null,
     ...
     */
     secrets(namespace) {
        return coreK8sApi.listNamespacedSecret(namespace, null, null, null, null,
            this.info.getPackageLabel()).then(response => {
            return response.body.items;
        })
    }
    ...
    pipelines(namespace) {
        ...
        return customK8sApi.listNamespacedCustomObject(constants.ARGO_DATAFLOW_K8S_API_GROUP, constants.ARGO_K8S_API_VERSION, 
            namespace, plural, null, null, null, this.info.getPackageLabel()).then(response => {
            return response.body.items;
        })
    }
