 ...
 */
exports.run = function (namespace, name, templateName, serviceAccountName, imagePullSecrets, cluster, cronString, timeZone) {
    ...
    return Package.info(namespace, name, cluster).then(argoPackage => {
        ...
        return argoPackage.run(runArguments, serviceAccountName, imagePullSecrets, cluster, namespace, cronString, timeZone);
    })
}